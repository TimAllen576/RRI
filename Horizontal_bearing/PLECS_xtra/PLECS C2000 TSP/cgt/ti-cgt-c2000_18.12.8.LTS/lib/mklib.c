...
library_t LIBRARIES[] = {
    { "rts2800_fpu64_eabi_eh.lib", { "EABI","GENERIC_MATH_COMMON_DOUBLE","C28EABI","GENERIC_MATH_COMMON_32BIT","GENERIC_MATH_COMMON","GENERIC_MATH_COMMON_FLOAT","GENERIC_MATH_COMMON_64BIT","IDIV","FPU64","EABI_TDEH","EXCEPTIONS","CLA_MATH" } },
    { "rts2800_ml_eabi.lib", { "GENERIC_MATH_COMMON_FLOAT","GENERIC_MATH_COMMON_64BIT","EABI","GENERIC_MATH_COMMON_DOUBLE","GENERIC_MATH_COMMON_32BIT","GENERIC_MATH_COMMON","DOUBLE_DIV_NOFPU64","C28EABI","LARGE","CLA_MATH" } },
    { "rts2800_fpu32_eabi_eh.lib", { "GENERIC_MATH_COMMON_FLOAT","GENERIC_MATH_COMMON_64BIT","IDIV","GENERIC_MATH_COMMON","GENERIC_MATH_COMMON_32BIT","DOUBLE_DIV_NOFPU64","FPU32","CLA_MATH","EABI_TDEH","EXCEPTIONS","GENERIC_MATH_COMMON_DOUBLE","EABI","C28EABI" } },
    { "rts2800_ml_eabi_eh.lib", { "GENERIC_MATH_COMMON_DOUBLE","EABI","LARGE","C28EABI","GENERIC_MATH_COMMON_64BIT","GENERIC_MATH_COMMON_FLOAT","GENERIC_MATH_COMMON","GENERIC_MATH_COMMON_32BIT","DOUBLE_DIV_NOFPU64","CLA_MATH","EXCEPTIONS","EABI_TDEH" } },
    { "rts2800_fpu32_eabi.lib", { "C28EABI","GENERIC_MATH_COMMON_DOUBLE","EABI","CLA_MATH","FPU32","DOUBLE_DIV_NOFPU64","GENERIC_MATH_COMMON","GENERIC_MATH_COMMON_32BIT","IDIV","GENERIC_MATH_COMMON_64BIT","GENERIC_MATH_COMMON_FLOAT" } },
    { "rts2800_fpu64_eabi.lib", { "EABI","IDIV","FPU64","GENERIC_MATH_COMMON_64BIT","GENERIC_MATH_COMMON_FLOAT","GENERIC_MATH_COMMON_DOUBLE","GENERIC_MATH_COMMON_32BIT","GENERIC_MATH_COMMON","C28EABI","CLA_MATH" } },
    { "rts2800_fpu32_eh.lib", { "FULL_PORTABLE_EH","DOUBLE_DIV_NOFPU64","FPU32","EXCEPTIONS" } },
    { "rts2800_ml_eh.lib", { "FULL_PORTABLE_EH","DOUBLE_DIV_NOFPU64","LARGE","EXCEPTIONS" } },
