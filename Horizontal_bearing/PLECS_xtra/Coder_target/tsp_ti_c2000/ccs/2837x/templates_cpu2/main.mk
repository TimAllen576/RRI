...
-O0 \
--include_path="$(TARGET_ROOT)/app_cpu2" \
...
download: $(BIN_DIR)/$(OUT_NAME).out $(BIN_DIR)/$(BASE_NAME).ccxml
	"$(FLASH_EXE)" --flash --core=2 --config=$(call FixPath,$(BIN_DIR)/$(BASE_NAME).ccxml) $(call FixPath,$(BIN_DIR)/$(OUT_NAME).out) $(AUTO_START_OPTION)
else
download:
...
##########################################################################
$(BIN_DIR)/main.obj:	$(call EscapeSpaces,$(TARGET_ROOT))/app_cpu2/main.c $(HFILES)
						"$(CGT_EXE_PATH)"/cl2000 $(C_OPTIONS) "$<"
...
$(BIN_DIR)/F2837xD_Adc.obj:	$(call EscapeSpaces,$(TARGET_ROOT))/tisrc/F2837xD_Adc.c $(HFILES)
						"$(CGT_EXE_PATH)"/cl2000 $(C_OPTIONS) "$<"

$(BIN_DIR)/F2837xD_DefaultISR.obj:	$(call EscapeSpaces,$(TARGET_ROOT))/tisrc/F2837xD_DefaultISR.c $(HFILES)
						"$(CGT_EXE_PATH)"/cl2000 $(C_OPTIONS) "$<"

$(BIN_DIR)/F2837xD_GlobalVariableDefs.obj:	$(call EscapeSpaces,$(TARGET_ROOT))/tisrc/F2837xD_GlobalVariableDefs.c $(HFILES)
						"$(CGT_EXE_PATH)"/cl2000 $(C_OPTIONS) "$<"

$(BIN_DIR)/F2837xD_DevInit.obj:	$(call EscapeSpaces,$(TARGET_ROOT))/tisrc/F2837xD_DevInit.c $(HFILES)
						"$(CGT_EXE_PATH)"/cl2000 $(C_OPTIONS) "$<"

$(BIN_DIR)/F2837xD_Gpio.obj:	$(call EscapeSpaces,$(TARGET_ROOT))/tisrc/F2837xD_Gpio.c $(HFILES)
						"$(CGT_EXE_PATH)"/cl2000 $(C_OPTIONS) "$<"

$(BIN_DIR)/F2837xD_CodeStartBranch.obj:	$(call EscapeSpaces,$(TARGET_ROOT))/tisrc/F2837xD_CodeStartBranch.asm $(HFILES)
						"$(CGT_EXE_PATH)"/cl2000 $(C_OPTIONS) "$<"

$(BIN_DIR)/F2837xD_usDelay.obj:	$(call EscapeSpaces,$(TARGET_ROOT))/tisrc/F2837xD_usDelay.asm $(HFILES)
						"$(CGT_EXE_PATH)"/cl2000 $(C_OPTIONS) "$<"
