...
// not sure if needed...
extern bool PLX_CANBUS_readyForTx(PLX_CANBUS_Handle_t aHandle, uint16_t aMailBox);

// not sure if needed...
extern void PLX_CANBUS_getAndClearNewMsgFlag(PLX_CANBUS_Handle_t aHandle, uint16_t aMailBox);
