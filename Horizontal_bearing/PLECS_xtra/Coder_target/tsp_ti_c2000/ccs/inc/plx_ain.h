...
extern void PLX_AIN_sinit(float aVref, uint32_t aSysClkHz);

extern PLX_AIN_Handle_t PLX_AIN_init(void *aMemory, const size_t aNumBytes);

extern void PLX_AIN_setDefaultAdcParams(PLX_AIN_AdcParams_t *aParams);
...
extern uint16_t PLX_AIN_getIn(PLX_AIN_Handle_t aHandle, uint16_t aChannel);
