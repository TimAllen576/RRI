...
$(BIN_DIR)/DSP2833x_GlobalVariableDefs.obj:	$(call EscapeSpaces,$(TARGET_ROOT))/tisrc/DSP2833x_GlobalVariableDefs.c $(HFILES)
						"$(CGT_EXE_PATH)"/cl2000 $(C_OPTIONS) "$<"

$(BIN_DIR)/DevInit_F2833x.obj:	$(call EscapeSpaces,$(TARGET_ROOT))/tisrc/DevInit_F2833x.c $(HFILES)
						"$(CGT_EXE_PATH)"/cl2000 $(C_OPTIONS) "$<"

$(BIN_DIR)/DSP2833x_CodeStartBranch.obj:	$(call EscapeSpaces,$(TARGET_ROOT))/tisrc/DSP2833x_CodeStartBranch.asm $(HFILES)
						"$(CGT_EXE_PATH)"/cl2000 $(C_OPTIONS) "$<"

$(BIN_DIR)/DSP2833x_usDelay.obj:	$(call EscapeSpaces,$(TARGET_ROOT))/tisrc/DSP2833x_usDelay.asm $(HFILES)
						"$(CGT_EXE_PATH)"/cl2000 $(C_OPTIONS) "$<"

$(BIN_DIR)/pwm_2833x.obj:	$(call EscapeSpaces,$(TARGET_ROOT))/src/pwm_2833x.c $(HFILES)
						"$(CGT_EXE_PATH)"/cl2000 $(C_OPTIONS) "$<"

$(BIN_DIR)/ain_2833x.obj:	$(call EscapeSpaces,$(TARGET_ROOT))/src/ain_2833x.c $(HFILES)
						"$(CGT_EXE_PATH)"/cl2000 $(C_OPTIONS) "$<"

$(BIN_DIR)/dio_2833x.obj:	$(call EscapeSpaces,$(TARGET_ROOT))/src/dio_2833x.c $(HFILES)
						"$(CGT_EXE_PATH)"/cl2000 $(C_OPTIONS) "$<"

$(BIN_DIR)/qep_2833x.obj:	$(call EscapeSpaces,$(TARGET_ROOT))/src/qep_2833x.c $(HFILES)
						"$(CGT_EXE_PATH)"/cl2000 $(C_OPTIONS) "$<"

$(BIN_DIR)/sci_2833x.obj:	$(call EscapeSpaces,$(TARGET_ROOT))/src/sci_2833x.c $(HFILES)
						"$(CGT_EXE_PATH)"/cl2000 $(C_OPTIONS) "$<"

$(BIN_DIR)/spi_2833x.obj:	$(call EscapeSpaces,$(TARGET_ROOT))/src/spi_2833x.c $(HFILES)
						"$(CGT_EXE_PATH)"/cl2000 $(C_OPTIONS) "$<"

$(BIN_DIR)/cap_2833x.obj:	$(call EscapeSpaces,$(TARGET_ROOT))/src/cap_2833x.c $(HFILES)
						"$(CGT_EXE_PATH)"/cl2000 $(C_OPTIONS) "$<"
						
$(BIN_DIR)/canbus_2833x.obj:	$(call EscapeSpaces,$(TARGET_ROOT))/src/canbus_2833x.c $(HFILES)
						"$(CGT_EXE_PATH)"/cl2000 $(C_OPTIONS) "$<"
