...
ifeq ($(INSTASPIN),YES)
C_SOURCE_FILES += |>BASE_NAME<|_user.c
endif
...
ifeq ($(INSTASPIN),YES)
C_OPTIONS += --include_path="$(TARGET_ROOT)/tiinc/fast"
endif
...
$(BIN_DIR)/f28004x_adc.obj:	$(call EscapeSpaces,$(TARGET_ROOT))/tisrc/f28004x_adc.c $(HFILES)
						"$(CGT_EXE_PATH)"/cl2000 $(C_OPTIONS) "$<"

$(BIN_DIR)/f28004x_cputimers.obj:	$(call EscapeSpaces,$(TARGET_ROOT))/tisrc/f28004x_cputimers.c $(HFILES)
						"$(CGT_EXE_PATH)"/cl2000 $(C_OPTIONS) "$<"

$(BIN_DIR)/f28004x_defaultisr.obj:	$(call EscapeSpaces,$(TARGET_ROOT))/tisrc/f28004x_defaultisr.c $(HFILES)
						"$(CGT_EXE_PATH)"/cl2000 $(C_OPTIONS) "$<"

$(BIN_DIR)/f28004x_devinit.obj:	$(call EscapeSpaces,$(TARGET_ROOT))/tisrc/f28004x_devinit.c $(HFILES)
						"$(CGT_EXE_PATH)"/cl2000 $(C_OPTIONS) "$<"

$(BIN_DIR)/f28004x_globalvariabledefs.obj:	$(call EscapeSpaces,$(TARGET_ROOT))/tisrc/f28004x_globalvariabledefs.c $(HFILES)
						"$(CGT_EXE_PATH)"/cl2000 $(C_OPTIONS) "$<"

$(BIN_DIR)/f28004x_gpio.obj:	$(call EscapeSpaces,$(TARGET_ROOT))/tisrc/f28004x_gpio.c $(HFILES)
						"$(CGT_EXE_PATH)"/cl2000 $(C_OPTIONS) "$<"

$(BIN_DIR)/f28004x_codestartbranch.obj:	$(call EscapeSpaces,$(TARGET_ROOT))/tisrc/f28004x_codestartbranch.asm $(HFILES)
						"$(CGT_EXE_PATH)"/cl2000 $(C_OPTIONS) "$<"

$(BIN_DIR)/f28004x_usdelay.obj:	$(call EscapeSpaces,$(TARGET_ROOT))/tisrc/f28004x_usdelay.asm $(HFILES)
						"$(CGT_EXE_PATH)"/cl2000 $(C_OPTIONS) "$<"

$(BIN_DIR)/pwm_28004x.obj:	$(call EscapeSpaces,$(TARGET_ROOT))/src/pwm_28004x.c $(HFILES)
						"$(CGT_EXE_PATH)"/cl2000 $(C_OPTIONS) "$<"

$(BIN_DIR)/ain_28004x.obj:	$(call EscapeSpaces,$(TARGET_ROOT))/src/ain_28004x.c $(HFILES)
						"$(CGT_EXE_PATH)"/cl2000 $(C_OPTIONS) "$<"

$(BIN_DIR)/dio_28004x.obj:	$(call EscapeSpaces,$(TARGET_ROOT))/src/dio_28004x.c $(HFILES)
						"$(CGT_EXE_PATH)"/cl2000 $(C_OPTIONS) "$<"

$(BIN_DIR)/qep_28004x.obj:	$(call EscapeSpaces,$(TARGET_ROOT))/src/qep_28004x.c $(HFILES)
						"$(CGT_EXE_PATH)"/cl2000 $(C_OPTIONS) "$<"

$(BIN_DIR)/sci_28004x.obj:	$(call EscapeSpaces,$(TARGET_ROOT))/src/sci_28004x.c $(HFILES)
						"$(CGT_EXE_PATH)"/cl2000 $(C_OPTIONS) "$<"

$(BIN_DIR)/spi_28004x.obj:	$(call EscapeSpaces,$(TARGET_ROOT))/src/spi_28004x.c $(HFILES)
						"$(CGT_EXE_PATH)"/cl2000 $(C_OPTIONS) "$<"
						
$(BIN_DIR)/pga_28004x.obj:	$(call EscapeSpaces,$(TARGET_ROOT))/src/pga_28004x.c $(HFILES)
						"$(CGT_EXE_PATH)"/cl2000 $(C_OPTIONS) "$<"

$(BIN_DIR)/dac_28004x.obj:	$(call EscapeSpaces,$(TARGET_ROOT))/src/dac_28004x.c $(HFILES)
						"$(CGT_EXE_PATH)"/cl2000 $(C_OPTIONS) "$<"
						
$(BIN_DIR)/cap_28004x.obj:	$(call EscapeSpaces,$(TARGET_ROOT))/src/cap_28004x.c $(HFILES)
						"$(CGT_EXE_PATH)"/cl2000 $(C_OPTIONS) "$<"
						
$(BIN_DIR)/canbus_28004x.obj:	$(call EscapeSpaces,$(TARGET_ROOT))/src/canbus_28004x.c $(HFILES)
						"$(CGT_EXE_PATH)"/cl2000 $(C_OPTIONS) "$<"
